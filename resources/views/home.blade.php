...
@section('content')
        ...
        <div class="container">
            <div class="col-md-10 mx-auto py-5">
                ...
                <div class="owl-carousel owl-theme slider-default">
                    ...
                    <div class="item slide-items">
                        <div class="slide border">
                            <img src="{{ asset('assets/images/slider-one/slider-one-4.png') }}" alt="">
                            <div class="px-3 px-md-5 py-4 text-center h-100">
                                <h3 class="f-16 fw-bold text-capitalize f-roboto fst-italic">Convenient Ride</h3>
                                <p>Effortlessly conquer hills, headwinds and long distances route with e-bikes!</p>
                            </div>
                        </div>
                    </div>
                    <div class="item slide-items">
                        <div class="slide border">
                            <img src="{{ asset('assets/images/slider-one/slider-one-5.png') }}" alt="">
                            <div class="px-3 px-md-5 py-4 text-center h-100">
                                <h3 class="f-16 fw-bold text-capitalize f-roboto fst-italic">It's fun</h3>
                                <p>Riding e-bikes should be fun for everyone, regardless of age or fitness level.</p>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="row g-5 align-items-center">
                    <div class="col-md-8">
                        <div class="owl-carousel owl-theme slider-one">
                            <div class="item">
                                <div class="slide">
                                    <img src="{{ asset('assets/images/slider-destination/slider-two-1.png') }}" alt="">
                            ...
                            <div class="item">
                                <div class="slide">
                                    <img src="{{ asset('assets/images/slider-destination/slider-two-2.png') }}" alt="">
                                    <h3 class="position-absolute fw-bold text-uppercase m-0 text-white"
                            ...
                            <div class="item">
                                <div class="slide">
                                    <img src="{{ asset('assets/images/slider-destination/slider-two-3.png') }}" alt="">
                                    <h3 class="position-absolute fw-bold text-uppercase m-0 text-white"
                            ...
                            <div class="item">
                                <div class="slide">
                                    <img src="{{ asset('assets/images/slider-destination/slider-two-4.png') }}" alt="">
                                    <h3 class="position-absolute fw-bold text-uppercase m-0 text-white"
                            ...
                            <div class="item">
                                <div class="slide">
                                    <img src="{{ asset('assets/images/slider-destination/slider-two-5.png') }}" alt="">
                                    <h3 class="position-absolute fw-bold text-uppercase m-0 text-white"
                ...
                <div class="owl-carousel owl-theme slider-default">
                    <div class="item slide-items">
                        <div class="slide text-white b-main-color">
                            ...
                            <div>
                                <p class="fw-bold text-uppercase b-soft-black p-3 mb-0 f-16 text-center fst-italic">49 USD or IDR
                                    700K/Person</p>
                            </div>
                        </div>
                    </div>
                    <div class="item slide-items">
                        <div class="slide text-white b-main-color">
                            ...
                            <div>
                                <p class="fw-bold text-uppercase b-soft-black p-3 mb-0 f-16 text-center fst-italic">79 USD or IDR
                                    1.100K/Person</p>
                            </div>
                        </div>
                    </div>
                    <div class="item slide-items">
                        <div class="slide text-white b-main-color">
                            ...
                            <div>
                                <p class="fw-bold text-uppercase b-soft-black p-3 mb-0 f-16 text-center fst-italic">120 USD or IDR
                                    1.800K/Person</p>
                            </div>
                        </div>
                    </div>
                    <div class="item slide-items">
                        <div class="slide text-white b-main-color">
                            <div class="p-4 mb-auto">
                                <h3 class="fw-bold text-uppercase f-20">CUSTOMIZED e-bike tour</h3>
                                <ul>
    ...
    <section>
        <div class="container">
            ...
            <div class="item slide-items">
                    <div class="slide text-black b-white border-grey text-center">
                        <div class="p-4 p-md-5 my-auto">
                            ...
                            <h3 class="fw-bold text-uppercase h6 py-4 mb-0 fst-italic">“Amazing experience”</h3>
                ...
                <div class="item slide-items">
                    <div class="slide text-black b-white border-grey text-center">
                        <div class="p-4 p-md-5 my-auto">
                            ...
                            <h3 class="fw-bold text-uppercase h6 py-4 mb-0 fst-italic">“So easy to ride a long track”</h3>
                ...
                <div class="item slide-items">
                    <div class="slide text-black b-white border-grey text-center">
                        <div class="p-4 p-md-5 my-auto">
                            ...
                            <h3 class="fw-bold text-uppercase h6 py-4 mb-0 fst-italic">“Such a memorable experience”</h3>
        ...
        <div class="container">
            <div class="col-md-10 mx-auto p-y-150 p-md-y-50">
                <div class="row align-items-center">
                    ...
                    <div class="col-md-8">
                        <div class="owl-carousel owl-theme slider-three slider-no-nav">
                            <div class="item">
                                <div class="slide">
                            ...
                            <div class="item">
                                <div class="slide">
                                    <img src="{{ asset('assets/images/slider-three/slider-9.png') }}" alt="">
                                </div>
                            </div>
                            <div class="item">
                                <div class="slide">
                                    <img src="{{ asset('assets/images/slider-three/slider-10.png') }}" alt="">
                                </div>
                            </div>
                        </div>
                    </div>
